      ...
      return Row(
        ...
        children: <Widget>[
          Container(
            ...
            width: 120.0,
            child: Image.network(cartProduct.productData.image),
          ),
          Expanded(
            child: Container(
              padding: EdgeInsets.all(8.0),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Configuração: ${cartProduct.productData.options[cartProduct.option]}",
                    style: TextStyle(fontWeight: FontWeight.w300),
                  ),
                  Text(
                    "R\$ ${double.parse(cartProduct.productData.prices[cartProduct.option].toString()).toStringAsFixed(2)}",
                    style: TextStyle(
